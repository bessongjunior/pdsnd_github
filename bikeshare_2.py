...
#this function is used to load data at the time_stats function
...
def get_input(message, available_options):
    #Gets user input using a while loop to validate user submissions
    while True:
...
def station_stats(df):
    ...
    print_message('The most commonly used end station was: ', df['End Station'].mode()[0])
     ...
     #Credit: https://pandas.pydata.org/pandas-docs/stable/user_guide/cookbook.html
...
def main():
    while True:
        ...
        #if raw_data == 'yes':
         #   print(df.head())
         # review update to display raw data of the first five row   
        while True:
        ...
        #function to restart and / or stop the program
